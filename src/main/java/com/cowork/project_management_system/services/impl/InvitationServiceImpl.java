...
import com.cowork.project_management_system.repository.Invitations;
...
private final EmailServicesImpl emailServices;
    ...
    public void sendInvitation(String email,Long projectId) throws MessagingException {
        ...
        String invitationLink="http://localhost:8080/api/projects/accept-invite?token="+InvitationToken;
